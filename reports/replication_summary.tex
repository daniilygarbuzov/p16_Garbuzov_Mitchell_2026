...
\section{Basis-Sorted Portfolios}

From here, we move onto constructing Table~II, which reports returns for basis-sorted portfolios. We do this for the baseline sample
(March 1986--December 2010) and the extended sample (March 1986--present-day).

This table is different from Table~I in that it sorts commodities into portfolios based on their basis. 
From there, we compute annualized mean returns, standard deviations, and t-statistics for Short Roll and Excess Holding returns across the basis-sorted portfolios.

% Baseline sample Table 2
\input{../_output/table2.tex}

\clearpage

% Extended sample Table 2
